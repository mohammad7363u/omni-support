...
from fastapi import APIRouter, Depends, HTTPException, WebSocket, WebSocketDisconnect, Query, Response, Body
...
from app.schemas import (
    ...
    TicketTagsUpdateRequest, InternalNoteCreate, TicketBulkUpdateRequest
)
